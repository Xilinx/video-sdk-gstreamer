...
# This script accepts an 8-bit and 10-bit, YUV420, pre-encoded 60FPS MP4 file with h.264 content. It will scale this input into multiple renditions of various sizes# , and send them back to disk in /tmp/
...
if [ $# -lt 3 ]; then
     ...
     echo "$0 <device index> <Input H264 file> <num instances, 1 to 4> <Number of buffers> <fakesink 0/1>"
