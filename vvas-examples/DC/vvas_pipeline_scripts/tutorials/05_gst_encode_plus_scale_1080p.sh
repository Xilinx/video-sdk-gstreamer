...
# This script accepts an 8-bit and 10-bit, YUV420, 1080p60 RAW file and will send it to the scaler, which outputs various renditions of various sizes,
...
if [ $# -lt 3 ]; then
     ...
     echo "$0 <device index> <1080p60 nv12 RAW file> <num instances, 1 to 4> <Number of buffers> <10bitinput 0/1> <fakesink 0/1>"
     echo -e "\e[01;31m"e.g $0 0 Test_1920x1080.nv12 1 2000 1 0"\e[0m"
     echo "<Number of buffers> - Input number of buffers to be processed from input file" 
     echo "<Number of buffers> - -1, will take the complete input video stream" 
     echo ""
...
pipe="gst-launch-1.0 filesrc location=$2 blocksize=3110400 
	! queue 
