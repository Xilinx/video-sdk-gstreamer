...
if [ $# -lt 3 ]; then
     ...
     echo "$0 <Device Index> <Input 4K H265/HEVC file> <Number of transcode instances, 1 to 2> <fakesink 0/1>"
     echo "Ex: $0 0 ~/videos/Test_4k_60fps.h265 1 1" 
     echo "Ex: $0 0 <4K30fps h265 file> 2 1" 
     exit 1
fi
...
pipe="filesrc location=$inputfile
	${demuxer}
	! h265parse
